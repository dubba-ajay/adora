  ...
  const plans = [
    {
      ...
      badge: "For Startups",
      monthlyPrice: 5999,
      description: "Perfect for getting started with digital marketing",
      color: "gray",
      ...
      features: [
        ...
        { name: "Google & Facebook Ads", value: "", included: false },
        { name: "Referral Program", value: "", included: false },
      ...
      savings: "Great for getting started"
    },
    {
      id: "growth",
      name: "Growth Plan",
      ...
      popular: true,
      features: [
        { name: "AI Content Studio", value: "300 posts/month", included: true },
        { name: "Social Media Management", value: "5 accounts", included: true },
        { name: "Email Marketing", value: "5,000 emails/month", included: true },
        { name: "WhatsApp Campaigns", value: "1,500 messages/month", included: true, tooltip: "Meta charges apply" },
        { name: "Business Profile Setup", value: "Advanced", included: true },
        ...
        { name: "Google & Facebook Ads", value: "Management included", included: true, tooltip: "Ad spend paid directly to platform" },
        { name: "Referral Program", value: "", included: false },
        { name: "Priority Support", value: "", included: false },
      ],
      extras: [
      ...
      savings: "Save 30% vs Starter + extras"
    },
    {
      id: "premium",
      name: "Premium Plan",
      ...
      buttonVariant: "default" as const,
      features: [
        { name: "AI Content Studio", value: "Unlimited posts", included: true },
        { name: "Social Media Management", value: "Unlimited accounts", included: true },
        { name: "Email Marketing", value: "15,000 emails/month", included: true },
        { name: "WhatsApp Campaigns", value: "5,000 messages/month", included: true, tooltip: "Meta charges apply" },
        { name: "Business Profile Setup", value: "Premium + SEO", included: true },
        { name: "Lead Management CRM", value: "Unlimited leads", included: true },
        { name: "SEO Management", value: "15 keywords", included: true },
        { name: "Festival Campaigns", value: "Unlimited", included: true },
        { name: "Advanced Analytics", value: "Advanced + AI insights", included: true },
        { name: "Google & Facebook Ads", value: "Full management", included: true, tooltip: "Ad spend paid directly to platform" },
        { name: "Referral Program", value: "Setup & automation", included: true },
        { name: "Priority Support", value: "24/7 premium support", included: true },
      ],
      extras: [
      ...
      savings: "Best for complete automation"
    }
  ];
  ...
  const addOns = [
    {
      ...
      price: "₹299/1,000 messages",
      description: "Additional WhatsApp marketing capacity"
    },
    {
      name: "Extra Email Campaigns",
      price: "₹199/1,000 emails",
  ...
  return (
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-orange-50/30">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
                Flexible plans with everything you need to grow online. Upgrade anytime as your business scales.
              </p>
                ...
                >
                  {plan.popular && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                      <Badge className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-4 py-1 text-sm">
                      ...
                      {isYearly && (
                        <div className="mt-2">
                          ...
                          <Badge className="ml-2 bg-green-100 text-green-800 text-xs">
                            Save ₹{((plan.monthlyPrice - getMonthlyPrice(plan.monthlyPrice)) * 12).toLocaleString('en-IN')}/year
                          </Badge>
                        </div>
                      )}
                    </div>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="pt-6 border-t">
                      <h4 className="text-sm font-semibold text-gray-900 mb-3">
                        {plan.id === 'premium' ? 'Included Benefits:' : 'Available Extras:'}
                      </h4>
                ...
                <Card key={index} className="hover:shadow-lg transition-shadow">
                  <CardContent className="p-6 text-center">
                    <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mx-auto mb-4">
                      {index === 0 && <MessageSquare className="w-6 h-6 text-blue-600" />}
                      {index === 1 && <Mail className="w-6 h-6 text-blue-600" />}
                      {index === 2 && <Calendar className="w-6 h-6 text-blue-600" />}
                      {index === 3 && <HeadphonesIcon className="w-6 h-6 text-blue-600" />}
                    </div>
                ...
                <CardContent className="p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-1">Platform Features Included</h4>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-1">Third-Party Charges</h4>
                        <p className="text-sm text-gray-600">
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 via-blue-500 to-orange-500">
