    ...
    activities: [
      {
        id: "1",
        type: "note",
        description: "Lead created for testing",
...
export default function LeadManagementModern() {
  ...
  const startEditLead = useCallback((lead) => {
    setEditingLead(lead);
    setNewLead({
      name: lead.name,
      email: lead.email,
  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto px-4 lg:px-6 space-y-8 max-w-7xl">
        {/* Modern Header */}
              ...
              <Card className="col-span-full">
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Start by adding your first lead or adjust your filters to see existing leads.
                  </p>
                  <Button
                    onClick={() => setIsAddingLead(true)}
        ...
        <Dialog open={isEditingLead} onOpenChange={setIsEditingLead}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Update the lead information in your CRM system.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <Button variant="outline" onClick={() => setIsEditingLead(false)}>
                  Cancel
                </Button>
              </div>
            </div>
